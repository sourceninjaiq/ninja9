...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local Ninja61 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..Ninja61.server.uptime_in_days..'('..Ninja61.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..Ninja61.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..Ninja61.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..Ninja61.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/ninja9/master/BOYKA.lua')
...
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/NINJAIQBOT/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('BOYKA.lua')  
end
