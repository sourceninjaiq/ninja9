...
{'جلب نسخه احتياطيه 📂','الاصدار 📟','ايديي'}, 
{'تحديث السورس ™'},
{'معلومات السيرفر'},
...
if text == "تعطيل التحقق" and Constructor(msg) then
    database:del(bot_id..'ninja9:nwe:mem:group'..msg.chat_id_) 
    send(msg.chat_id_, msg.id_,'\n- تم تعطيل التحقق' ) 
    end
if text == "تفعيل التحقق" and Constructor(msg) then
    database:set(bot_id..'ninja9:nwe:mem:group'..msg.chat_id_,'true') 
    send(msg.chat_id_, msg.id_,'\n- تم تفعيل التحقق' ) 
    end

    if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'ninja9:nwe:mem:group'..msg.chat_id_) == 'true'then
    numphoto = {'3','8','9','6'}
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data="م1"},{text = 'اوامر الادمنيه', callback_data="م2"},{text = 'اوامر المدراء', callback_data="/م3"},
},
{
{text = 'اوامر المنشئين', callback_data="م4"},{text = 'اوامر المطور اساسي', callback_data="م5"},
},
{
{text = 'اوامر التحشيش', callback_data="م6"},{text = 'اوامر مطورين البوت', callback_data="م7"},{text = 'اوامر الاعضاء', callback_data="م8"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الادمنيه', callback_data="م2"},{text = 'اوامر المدراء', callback_data="/م3"},
},
{
{text = 'اوامر المنشئين', callback_data="م4"},{text = 'اوامر المطور اساسي', callback_data="م5"},
},
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data="م1"},{text = 'اوامر المدراء', callback_data="/م3"},
},
{
{text = 'اوامر المنشئين', callback_data="م4"},{text = 'اوامر المطور اساسي', callback_data="م5"},
},
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data="م1"},{text = 'اوامر الادمنيه', callback_data="م2"},
},
{
{text = 'اوامر المنشئين', callback_data="م4"},{text = 'اوامر المطور اساسي', callback_data="م5"},
},
...
{
{text = 'اوامر المطور اساسي', callback_data="م5"},
},
{
{text = 'اوامر التحشيش', callback_data="م6"},{text = 'اوامر مطورين البوت', callback_data="م7"},{text = 'اوامر الاعضاء', callback_data="م8"},
},
...
{
{text = 'اوامر المنشئين', callback_data="م4"},
},
{
{text = 'اوامر التحشيش', callback_data="م6"},{text = 'اوامر مطورين البوت', callback_data="م7"},{text = 'اوامر الاعضاء', callback_data="م8"},
},
...
{
{text = 'اوامر مطورين البوت', callback_data="م7"},{text = 'اوامر الاعضاء', callback_data="م8"},
},
{
{text = '🏆 الاوامر الرئيسيه 🏆', callback_data="الاوامر"},
},
...
{
{text = 'اوامر التحشيش', callback_data="م6"},{text = 'اوامر الاعضاء', callback_data="م8"},
},
{
{text = '🏆 الاوامر الرئيسيه 🏆', callback_data="الاوامر"},
},
...
{
{text = 'اوامر التحشيش', callback_data="م6"},{text = 'اوامر مطورين البوت', callback_data="م7"},
},
{
{text = '🏆 الاوامر الرئيسيه 🏆', callback_data="الاوامر"},
},
...
local text = text:match("^زخرفه (.*)$")
zh = https.request('https://ninja-api.000webhostapp.com/api/text.php?text='..URL.escape(text)..'')
zx = JSON.decode(zh)
t = "\n📮 | قائمه الزخرفه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
i = 0
...
------------------------------------------------------------------------
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."MA:zhrf_Bots"..msg.chat_id_) == "open" then
local type = text:match("^زخرفه (.*)$")
zh = https.request('https://ninja-api.000webhostapp.com/api/yt.php?type='..URL.escape(type)..'')
end
------------------------------------------------------------------------
