...
if tonumber(user_id) == tonumber(1897118484) then  
var = true  
...
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/ninja9/master/ninja9.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 2.0v}')
dofile('ninja9.lua')  
end
if text == 'تحويل للسورس بويكا' and SudoBot(msg) then 
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/ninja9Y/master/ninja9.lua')
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/MARCOSBOT/master/ninja9.lua')
...
local UserName = (b.username_ or "ChannelNinjaBOT")
...
---------
if text == ("رفع سيد") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل سيد")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n👤| المستخدم » ['..result.title_..'](t.me/'..(username or 'ninja9')..')'
status  = '\n🔘| تم حظره من المجموعه'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel NINJA 🦅](https://t.me/ChannelNinjaBOT)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
t = "\n🔘| قائمة المنع \nء━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local ninja9_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..ninja9_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..ninja9Source[math.random(#ninja9Source)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
local Name_Bot = (redis:get('ninja9:'..bot_id..'Name:Bot') or 'العالمي')
if not redis:get('ninja9:'..bot_id.."Fun_Bots:"..msg.chat_id_) then
...
-------------------------------------------------------------------------------------------------------------- 
if text and redis:get('ninja9:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = redis:get('ninja9:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
redis:del('ninja9:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..":"..text)
redis:del('ninja9:'..bot_id.."Set:Za:Group:New"..msg.chat_id_)
redis:srem('ninja9:'..bot_id.."List:ZaYon:Group:New"..msg.chat_id_,text)
...
redis:del('ninja9:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
---------------
if text then
local NewCmmd = redis:get('ninja9:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..':'..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
redis:set('ninja9:'..bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get('ninja9:'..bot_id.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
local Json_config = JSON.decode(ninja9)
...
if Constructor(msg) then 
redis:set('ninja9:'..bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = redis:get('ninja9:'..bot_id..'Pin:Id:Msg'..msg.chat_id_)
if Msg_Pin and redis:get('ninja9:'..bot_id.."lockpin"..msg.chat_id_) then
...
if redis:get('ninja9:'..bot_id..'lock:tagservr'..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
end   
--------------------------------------------------------------------------------------------------------------
Devninja9(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and Groups_Users(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
redis:set('ninja9:'..bot_id..'user:Name'..msg.sender_user_id_,(data.username_))
end
--------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------
local ninja9bot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if ninja9bot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..ninja9bot.."] \n") 
