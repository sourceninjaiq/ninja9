...
__ℳ_________🦅________homeland_𝕋𝕖𝔸𝕞_🦅_________ᔕ ____
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/homelandBOT1/Files_ninja9/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MARCOSBOT1/Files_ninja9/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ninja9.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس وطن\n") 
end
return false
end
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel homeland 🦅](https://t.me/iraqqpqp)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'وطن').."مغادره" or text == 'مغادره' or text == 'مغادرة' then  
