...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ninja9TEAM/Files_ninja9/master/File_Bot/commands.lua") 
...
ninja9_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
ninja9_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ninja9_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ninja9_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ninja9_Msg = 'رب التفاعل'  
end 
return ninja9_Msg 
end
...
os.execute('wget https://raw.githubusercontent.com/FASAZTEAE/ninja9/master/ninja9.lua')
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/ninja9TEAM/ninja9/master/ninja9.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ninja9TEAM/Files_ninja9/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ninja9TEAM/Files_ninja9/master/File_Bot/"..file)
if res == 200 then
