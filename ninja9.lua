...
{
{text = '- اوامر الحماية .', callback_data=msg.sender_user_id_.."/help1"},
},
{
{text = '- اوامر الادمنيه .', callback_data=msg.sender_user_id_.."/help2"},
},
{
{text = '- اوامر المدراء .', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = '- اوامر المنشئين .', callback_data=msg.sender_user_id_.."/help4"},
},
{
{text = '- اوامر المطور اساسي .', callback_data=msg.sender_user_id_.."/help5"},
},
{
{text = '- اوامر التحشيش .', callback_data=msg.sender_user_id_.."/help6"},
},
{
{text = '- اوامر مطورين البوت .', callback_data=msg.sender_user_id_.."/help7"},
},
{
{text = '- اوامر الاعضاء .', callback_data=msg.sender_user_id_.."/help8"},
},
{
{text = '- Source NINJA 🦅 .', url = "https://t.me/ChannelNinjaBOT"}
},
}
