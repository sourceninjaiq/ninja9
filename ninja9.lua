...
local ninja9 = {
"ان لم تعش لنفسك \n لن ياتيك العالم ليدلك على طريق الصحيح \n الكل لديه اولويات بعيده عنك تماما \n فان لن تحب نفسك لن يحبك الاخرين😔",
"جاور من يخاف الله \n وحاور من يحترمك \n وصاحب من يفهمك",
"الحياة \n ليست طويله حتى نجرب كل شئ \n ولا قصيره حتى تتذكر كل شئ \n ولكنها جميله \n اذا عرفنا انها لا تساوي شئ",
ايام
}
send(msg.chat_id_, msg.id_,'['..ninja9[math.random(#ninja9)]..']') 
return false
