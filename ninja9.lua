...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local ninja91 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..ninja91.server.uptime_in_days..'('..ninja91.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..ninja91.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..ninja91.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..ninja91.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/ninja9Y/master/ninja9.lua')
...
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/GLOBLA/master/GLOBLA.lua')
send(msg.chat_id_, msg.id_,'تحويل للسورس عالمي') 
dofile('GLOBLA.lua')  
end
if text == 'تحويل للسورس كلاكسي' and SudoBot(msg) then 
os.execute('rm -rf GALAXY.lua')
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/GALAXYY/master/GALAXY.lua')
send(msg.chat_id_, msg.id_,'تحويل للسورس كلاكسي') 
dofile('GALAXY.lua')  
end
if text == 'تحويل للسورس وطن' and SudoBot(msg) then 
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/homelandBOT‏/master/ninja9.lua')
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/sourceninjaiq/master/ninja9.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('ninja9.lua')  
end
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel NINJAIQ 🦅](https://t.me/ninjaIAQ)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
database:set(bot_id.."NE:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'🔚 تم تفعيل الابراج')
database:set(bot_id.."NE:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."NE:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."NE:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✖ تم تفعيل حساب العمر')
database:set(bot_id.."NE:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."NE:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."NE:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'🔶️ تم تفعيل الزخرفه')
database:set(bot_id.."NE:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."NE:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_,'['..ninja9[math.random(#ninjaIQ)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if text == 'تحبني' then
...
send(msg.chat_id_, msg.id_,'['..ninja9Source[math.random(#ninjaIQSource)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
