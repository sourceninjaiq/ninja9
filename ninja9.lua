...
if text and Devninja9(msg) and database:get(bot_id.."ninja9:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
   database:del(bot_id.."ninja9:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_)
...
if Replay then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'ninja9:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'ninja9:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
