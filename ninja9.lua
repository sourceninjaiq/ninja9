...
database:set(bot_id.."NE:text_Syria"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯┇تم تفعيل الزخرفه')
database:set(bot_id.."NE:text_Syria"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."NE:text_Syria"..msg.chat_id_) == "open" then
local textSyria = text:match("^زخرفه (.*)$")
zh = https.request('https://ninja-api.ml/nizk/index.php?text='..URL.escape(text)..'')
zx = JSON.decode(zh)
t = "\n📮 | قائمه الزخرفه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
i = 0
