...
os.execute('wget https://raw.githubusercontent.com/sourceninja9/ninja9/master/ninja9.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/sourceninja9/Files_ninja9/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/sourceninja9/Files_ninja9/master/File_Bot/"..file)
if res == 200 then
