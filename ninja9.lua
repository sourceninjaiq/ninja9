...
function plugin_ninja9(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.ninja9 and msg then
pre_msg = plugin.ninja9(msg)
end
end
end
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/homelandBOT‏/master/ninja9.lua')
...
os.execute('rm -rf ninja9.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/ninja9BOT/master/ninja9.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('ninja9.lua')  
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/sourceninjaiq/Files_ninja9/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/sourceninjaiq/Files_ninja9/master/File_Bot/"..file)
if res == 200 then
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel ninja9 🦅](https://t.me/ninjaIAQ)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
--------------------------------------------------------------------------------------------------------------
sourceninjaiq(data.message_,data)
plugin_ninja9(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
